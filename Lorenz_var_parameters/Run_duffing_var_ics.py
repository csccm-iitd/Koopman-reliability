...
label_tr= np.array(label_tr).reshape(10000,100,3)

#test
p_f = ff.failurefunction(data_tr2[:,:,0],[10,10,17],10000,40)
print(p_f)

# prediction
predict2=np.array(predict2)
p_f_p = ff.failurefunction(predict2[:,:,0],[10,10,17],10000,40)

#%% PDF of the fiorst passagea failure time
k1= ff.densityfunction(predict2[:,:,0],[10,10,17],10000,100)
k2= ff.densityfunction(data_tr2[:,:,0],[10,10,17],10000,100)
